...
address: "Hybrid, Remote and In-person"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "May 12 and 13, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Renata Curty", Ryan Horne", "Jon Jablonski"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes:  https://pad.carpentries.org/2022-05-16-ucsb-webscraping # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
{% endcomment %}
{% if page.eventbrite %}
<h3>Registration for this workshop opens April 22, 2022 at 8:00 AM PST</h3>
